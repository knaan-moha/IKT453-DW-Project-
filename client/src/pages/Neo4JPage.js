...
const neo4jQueries = [
  { 
    ...
    queryUrl: "http://localhost:5000/analytics?DB=neo4j&query=MATCH%20(n)%20RETURN%20n" 
  },
  { 
    text: "Get data from test table given id", 
    category: "Test Query 2", 
    queryUrl: "http://localhost:5000/analytics?DB=neo4j&query=MATCH%20(p:Person%20{name:%20$1})%20RETURN%20p&params=Alice" 
  }
];
